    ...
    <section id="services" class="bg-white py-24 px-6">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div onclick="window.location.href='prestation_details.php?cat=domicile'" class="group bg-sable-doux p-8 rounded-senior hover:bg-vert-menthe transition-all cursor-pointer shadow-sm">
                ...
                <div onclick="window.location.href='prestation_details.php?cat=loisirs'" class="group bg-sable-doux p-8 rounded-senior hover:bg-peche-pastel transition-all cursor-pointer shadow-sm">
                    <div class="bg-white w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-sm mx-auto">
                ...
                <div onclick="window.location.href='prestation_details.php?cat=sante'" class="group bg-sable-doux p-8 rounded-senior hover:bg-vert-menthe transition-all cursor-pointer shadow-sm">
                    <div class="bg-white w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-sm mx-auto">
